...
// format lands here rather than in dataDir() - dataDir is where tally's
...
// in front of the user for exactly that. Matches splitsy (tally's Go
// sibling) exactly.
...
// exportRecord/exportRows exactly, adapted to tally's Transaction shape.
